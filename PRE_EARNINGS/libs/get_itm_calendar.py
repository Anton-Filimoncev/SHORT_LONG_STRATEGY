...
def get_data_and_calc_itm_calendar(pool_input):
    ...
    try:
        ...
        strike_put_short = needed_strike_sell
        strike_put_long = needed_strike_sell
        ...
        print(err)
        RR, needed_strike_sell, needed_strike_buy,  proba_30, expected_return = np.nan, np.nan, np.nan, np.nan, np.nan
        pass
