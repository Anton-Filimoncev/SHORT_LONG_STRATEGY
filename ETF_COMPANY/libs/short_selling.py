...
def get_current_regime(pool_input):
    print('.')
    # CHAPTER 5: Regime Definition
    stock_yahoo, benchmark, start_date, tick = pool_input
    stock_yahoo = stock_yahoo[start_date:]
    ### RELATIVE
    ...
    #прогресс бар
    tqdm_params = {
        'total': len(stock_yahoo.columns.get_level_values(0).unique().tolist()),
        'miniters': 1,
        'unit': 'it',
        'unit_scale': True,
        'unit_divisor': 1024,
