...
from libs.get_bear_put_ratio_calendar import bear_put_ration_calendar_run
...
if __name__ == "__main__":
    ...
    bear_put_out =  bear_put_ration_calendar_run(main_data, stock_yahoo, poll_num, RISK_RATE, 'put')
    call_put_out = bear_put_ration_calendar_run(main_data, stock_yahoo, poll_num, RISK_RATE, 'call')

    main_data["Bear_Put_Ration_Calendar"] = bear_put_out
    main_data["Bull_Call_Ration_Calendar"] = call_put_out
