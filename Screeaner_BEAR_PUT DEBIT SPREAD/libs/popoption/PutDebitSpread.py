...
from .MonteCarlo_DIAGONAL import monteCarlo
import time
...
def putDebitSpread(underlying, sigma_short, sigma_long, rate, trials, days_to_expiration_short,
    ...
    max_profit = put_long_strike - put_short_strike - initial_debit
    ...
    try:
        pop, pop_error, avg_dtc, avg_dtc_error = monteCarlo(underlying, rate, sigma_short, sigma_long, days_to_expiration_short, days_to_expiration_long,
