...
from libs.get_itm_calendar import get_debet_spread
...
if __name__ == "__main__":
    ...
    # active_stock_df = pd.read_excel("active_stock/HIGH_CAP_COMPANY.xlsx")[:20]
    #
    ...
    active_stock_df = active_stock_df[active_stock_df['PCR PERCENTILE'] <= 5].reset_index(drop=True)
    tick_list = active_stock_df["Symbol"].values.tolist()
    print(active_stock_df)
    ...
    RR, needed_strike_sell, proba_30, expected_return = get_debet_spread(
