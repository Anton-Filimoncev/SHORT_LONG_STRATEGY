...
if __name__ == "__main__":
    ...
    days_to_exp = nearest_equal_abs(exp_date_df["Days_to_exp"], 600)
    needed_exp_date = (
    ...
    exp_dates_short = exp_date_df[exp_date_df["Days_to_exp"] >= 200]
    exp_dates_short = exp_dates_short[exp_dates_short["Days_to_exp"] <= 300]
    ...
    exp_move = hv * current_price * math.sqrt(200 / 365)
    ...
    needed_short = all_needed_exp_df_sell.iloc[0]

    # print('needed_short')
    # print(needed_short)

    exp_dates_long = exp_date_df[
        exp_date_df["Days_to_exp"] >= needed_short["Days_to_exp"] * 2
    ]
    ...
    needed_long = (
        chains[chains["strike"] == needed_strike_sell].reset_index(drop=True).iloc[0]
    )
